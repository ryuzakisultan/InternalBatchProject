...
public class TransRequestBatchTrack {
	...
	public TransRequestBatchTrack() {
		...
		currentUpperTraceAuditNumber = Math.min(CommonUtils.lowerTraceAuditNo + CommonUtils.batchSize,
				CommonUtils.upperTraceAuditNo);
	}
	...
	public boolean nextBatch() {
		if (currentLowerTraceAuditNumber < CommonUtils.upperTraceAuditNo) {
			if (batchStarted) {
				...
				currentUpperTraceAuditNumber = Math.min(currentUpperTraceAuditNumber + CommonUtils.batchSize,
						CommonUtils.upperTraceAuditNo);
			}
			batchStarted = true;
			return true;
